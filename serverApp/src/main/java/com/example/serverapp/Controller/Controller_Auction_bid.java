...
public class Controller_Auction_bid {
    ...
    public Controller_Auction_bid(Repo_auction repo_auction,Repo_auction_bid repo_auction_bid, Repo_v_auction repo_v_auction, Repo_v_amountuseraccount_available repo_v_amountuseraccount_available,Repo_Token repo_token) {
